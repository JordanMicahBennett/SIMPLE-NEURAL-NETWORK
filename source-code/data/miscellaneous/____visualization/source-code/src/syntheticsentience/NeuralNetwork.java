...
public class NeuralNetwork
{
    ...
    public double proximalMeanError, proximallyProximalMeanError, proximalMeanSmoothingFactor; 
    public double gradientError; //gradient error
    private boolean consoleDisplayQuery; //determines whether System.out.println calls are executed
    public double eta, alpha;
    public Variance variance;
    public double PURE_ERROR = 0.0;
    ...
    //define methods
        ...
        {
            corticalColumns = ( CorticalColumns ) new Utilities ( ).loadSerializable ( inputStream );
        }
        ...
        {
            new Utilities ( ).printSerializable ( getCorticalColumns ( ), outputStream );
        } 
